...
function getViewerConfiguration() {
  console.debug("---->getViewerConfiguration");
  return {
    ...
    tags: [{
      ...
      code: "1",
      dataTag: "住所地",
      dataDetail: "住所地detail1"
    }, {
      dataColor: "253, 140, 155",
      code: "2",
      dataTag: "信用卡中心",
      dataDetail: "信用卡中心detail2"
    }]
  };
}
function webViewerLoad() {
  console.debug("程序入口webViewerLoad..");
  let config = getViewerConfiguration();
  console.debug("config-->config");
  console.debug(config);
  if (typeof PDFJSDev === 'undefined' || !PDFJSDev.test('PRODUCTION')) {
    console.debug("!PDFJSDev.test('PRODUCTION') 1111111111");
    Promise.all([
