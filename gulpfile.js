...
gulp.task('mozcentral-pre', ['buildnumber', 'locale'], function () {
  ...
  var MOZCENTRAL_DIR = BUILD_DIR + 'mozcentral/',
      ...
      MOZCENTRAL_L10N_DIR = MOZCENTRAL_DIR + 'browser/locales/zh-CN/pdfviewer/',
  ...
  return merge([
    ...
    gulp.src(FIREFOX_EXTENSION_DIR + 'locale/zh-CN/*.properties')
